...
pub const ERR_UNSUPPORTED_PATTERN: &str = "unsupported pattern in IR lowering";
pub const ERR_UNSUPPORTED_TYPE_EXPR: &str = "unsupported type expression in IR lowering";
